...
class Answer extends \App\Common\Models\Questionnaire\Answer
{
    ...
    public function record($userId, $user_name, $user_headimgurl, $questionnaire_id, $random_id, array $answer_list, $score, $question_num, $correct_num, $wrong_num, $noanswer_num, $answer_time, array $memo = array())
    {
        $data = array();
        $data['user_id'] = $userId;
