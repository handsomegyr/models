...
class UpstreamMsgDistWeek extends \App\Common\Models\Weixin2\DataCube\UpstreamMsgDistWeek
{
    ...
    public function syncUpstreamMsgDistWeek($authorizer_appid, $component_appid, $agentid, $res, $now)
    {
        if (!empty($res['list'])) {
