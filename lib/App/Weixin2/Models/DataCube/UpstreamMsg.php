...
class UpstreamMsg extends \App\Common\Models\Weixin2\DataCube\UpstreamMsg
{
    ...
    public function syncUpstreamMsg($authorizer_appid, $component_appid, $agentid, $res, $now)
    {
        if (!empty($res['list'])) {
