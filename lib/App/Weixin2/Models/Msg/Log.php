...
class Log extends \App\Common\Models\Weixin2\Msg\Log
{
    ...
    private function getPrepareData($info)
    {
        ...
        $data['PayFinishTime'] = isset($info['PayFinishTime']) ? $info['PayFinishTime'] : '';
        ...
        $data['request_time'] = isset($info['request_time']) ? date("Y-m-d H:i:s", $info['request_time']) : '';
        $data['response_time'] = isset($info['response_time']) ? date("Y-m-d H:i:s", $info['response_time']) : '';
