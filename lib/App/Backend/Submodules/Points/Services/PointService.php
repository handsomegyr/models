...
class PointService
{
     ...
     * @param array $memo        
     */
    public function addOrReducePoint($point_category, $user_id, $user_name, $user_headimgurl, $points, $now, $uniqueId, $point_rule_id, $point_rule_code, $activity_id = 0, $channel = "", array $memo = array('memo' => ''))
    {
        if ('undefined' == $user_id) {
            return false;
        }
        ...
        // 记录积分日志
        $this->modelPointLog->log($point_category, $user_id, $user_name, $user_headimgurl, $points, $now, $uniqueId, $point_rule_id, $point_rule_code, $activity_id, $channel, $memo);
        return $pointUserInfo;
    }
}
