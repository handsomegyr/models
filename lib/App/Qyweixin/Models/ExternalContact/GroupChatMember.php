...
class GroupChatMember extends \App\Common\Models\Qyweixin\ExternalContact\GroupChatMember
{
     ...
     */
    public function getInfoByUserId($userid, $chat_id, $authorizer_appid, $provider_appid, $agentid)
    {
        $query = array();
        $query['userid'] = $userid;
    ...
    public function clearExist($chat_id, $authorizer_appid, $provider_appid, $agentid, $now)
    {
    ...
    public function syncMemberList($chat_id, $authorizer_appid, $provider_appid, $agentid, $res, $now)
    {
        /**
         * {
         *  "userid": "abel",
        ...
        if (!empty($res['group_chat']['member_list'])) {
            foreach ($res['group_chat']['member_list'] as $memberInfo) {
                ...
                $info = $this->getInfoByUserId($userid, $chat_id, $authorizer_appid, $provider_appid, $agentid);
