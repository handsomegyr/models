...
class SendLog extends \App\Common\Models\Qyweixin\ReplyMsg\SendLog
{

    /**
     * 记录
     */
    public function record($provider_appid, $authorizer_appid, $agentid, $reply_msg_id, $reply_msg_name, $msg_type, $media, $media_id, $thumb_media, $thumb_media_id, $title, $description, $music, $hqmusic, $kf_account, $keyword_id, $keyword, $keyword_reply_msg_type, $ToUserName, $FromUserName, $reply_msg_content, $log_time)
    {
        $datas = array(
            'provider_appid' => $provider_appid,
            'authorizer_appid' => $authorizer_appid,
            'agentid' => $agentid,
            'reply_msg_id' => empty($reply_msg_id) ? "" : $reply_msg_id,
