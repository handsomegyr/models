...
class FileContent extends \App\Common\Models\Cronjob\DataImport\FileContent
{
    ...
    {
        $insertData = array();
        $insertData['cron_time'] = new \MongoDate($cron_time);
        ...
        $insertData['process_time'] = new \MongoDate(strtotime('0001-01-01 00:00:00'));
        ...
        $insertData['returnback_time'] = new \MongoDate(strtotime('0001-01-01 00:00:00'));
        $insertData['returnback_uniqueId'] = '';

        $insertData['log_time'] = new \MongoDate($now);
